...
public class Principal {
        ...
        public void gerarTabela() {
                ...
                try {
                        ...
                        // System.out.println(calculaCompInsDirRand(auxArqRand.filesize()));
                        System.out.println("");
                        gravarLinhaTabela(pw, "Shell Sort", quantidadeCompOrd,
                                        calculaCompInsDirOrd(arquivoOrdenado.filesize()), quantidadeMovOrd, 0,
                                        tempoTotalOrd,
                                        quantidadeCompRev, calculaCompInsDirRev(auxArqReverso.filesize()),
                                        quantidadeMovRev, 0,
                        ...
                        // System.out.println(calculaCompInsDirRand(auxArqRand.filesize()));
                        System.out.println("");
                        gravarLinhaTabela(pw, "Radix Sort", quantidadeCompOrd,
                                        calculaCompInsDirOrd(arquivoOrdenado.filesize()), quantidadeMovOrd, 0,
                                        tempoTotalOrd,
                                        quantidadeCompRev, calculaCompInsDirRev(auxArqReverso.filesize()),
                                        quantidadeMovRev, 0,
                        ...
                        // System.out.println(calculaCompInsDirRand(auxArqRand.filesize()));
                        System.out.println("");
                        gravarLinhaTabela(pw, "Tim Sort", quantidadeCompOrd,
                                        calculaCompInsDirOrd(arquivoOrdenado.filesize()), quantidadeMovOrd, 0,
                                        tempoTotalOrd,
                                        quantidadeCompRev, calculaCompInsDirRev(auxArqReverso.filesize()),
                                        quantidadeMovRev, 0,
                        ...
                        // System.out.println(calculaCompInsDirRand(auxArqRand.filesize()));
                        System.out.println("");
                        gravarLinhaTabela(pw, "Merge 1ª Implement", quantidadeCompOrd,
                                        calculaCompInsDirOrd(arquivoOrdenado.filesize()), quantidadeMovOrd, 0,
                                        tempoTotalOrd,
                                        quantidadeCompRev, calculaCompInsDirRev(auxArqReverso.filesize()),
                                        quantidadeMovRev, 0,
